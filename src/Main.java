...
public class Main {
	...
	public static void main(String[] args) {
		...
		List<Integer> arrayList = populateArrayList(10000000);
		List<Integer> linkedList = populateLinkedList(1000000);
...
//				+ remove10000000ElementLinkedListMiddle);
	...
	/**
	 * Creates an ArrayList to this specified size.
	 */
	public static List<Integer> populateArrayList(int size){
	...
	/**
	 * Creates an LinkerList to this specified size.
	 */
	public static List<Integer> populateLinkedList(int size){
	...
	/**
	 * Adds an amount of elements to the beginning of the list.
	 */
	...
	/**
	 * Adds an amount of elements to the middle of a list.
	 */
	...
	/**
	 * Adds an amount of elements to the end of a list.
	 */
	public static void addElementsToEnd(List<Integer> list, 
			int numberOfElementsToAdd) {
	...
	/**
	 * Removes the specified amounts of elements from the beginning of a list.
	 */
	...
	/**
	 * Removes the specified amounts of elements from the middle of a list.
	 */
	...
	/**
	 * Removes the specified amounts of elements from the end of a list.
	 */
